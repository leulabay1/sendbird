...
class OpenChannelPageState extends State<OpenChannelPage> {
  final channelUrl = "sendbird_open_channel_14092_bf4075fbb8f12dc0df3ccc5c653f027186ac9211";
  ...
  void initState() {
    super.initState();
    widget.sendbirdSdk!.addChannelEventHandler('OpenChannel', MyOpenChannelHandler(this));
    widget.sendbirdSdk!.addConnectionEventHandler('OpenChannel', MyConnectionHandler(this));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        leading: IconButton( icon: Icon(Icons.arrow_back_ios_new, color: Colors.white, size: 7.w), onPressed: () => Navigator.pop(context)),
        ...
        title: Text(
          ...
          style: TextStyle(fontSize: 5.w, color: Color.fromARGB(255, 244, 240, 240)),
            maxLines: 1,),
        actions: [
          Icon(Icons.menu_rounded, size: 10.w, color: Colors.white,),
        ],
      ),
      body: Container(
        color: Color.fromARGB(255, 14, 13, 13),
        child: loading ? Center(
                child: CircularProgressIndicator( color: Color.fromARGB(255, 168, 168, 168),),
                ) : error ? Center( child: Text(
                  "Error while loading chat",
                  style: const TextStyle(fontSize: 16.0, color: Color.fromARGB(255, 176, 174, 174)),
                )) : Stack(  
          alignment: Alignment.bottomCenter,
          children: [
            messageList.isNotEmpty ? _list() : Container(color: Color.fromARGB(255, 14, 13, 13),),
            sendField(),
      ...
      child: ScrollablePositionedList.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          if (message.sender?.userId == widget.user?.userId) {
            return _messageBuilder(context, message);
          } else {
            return _otherMesageBuilder(context, message);
          }
        },
      ),
    );
  ...
  void _scroll(int index) async {
   ...
   Widget _messageBuilder(BuildContext context, BaseMessage message) {
    return Padding(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(colors: [const Color.fromARGB(255, 255, 0, 107), const Color.fromARGB(255, 255, 69, 147)], begin: Alignment.topLeft, end: Alignment.bottomCenter),
  ...
  Widget _otherMesageBuilder(BuildContext context, BaseMessage message) {
    return Container(
      padding: const EdgeInsets.only(top:5, bottom: 5, left: 5, right: 0),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          widget.widgets.imageNetwork(
          ...
          Container(
            ...
            child:Column(
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 4.w, color: Color.fromARGB(255, 165, 164, 164)),
                      ),
                    ),
                    SizedBox(width: 3.w,),
                    Container(
                ...
                Text(
                  message.message,
                  style: TextStyle(fontSize: 5.w, color: Color.fromARGB(255, 215, 213, 213)),
                ),
            ],),
          ),
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  maxLines: 3,
                  overflow: TextOverflow.ellipsis,
                    DateFormat('MMM dd, hh a').format(DateTime.fromMillisecondsSinceEpoch(message.createdAt))
                        .toString(),
                    style: const TextStyle(fontSize: 12.0, color:Color.fromARGB(255, 165, 164, 164), overflow: TextOverflow.ellipsis),
                  ),]
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: Row(
        children: [
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.add_outlined, color: Colors.white, size: 10.w, opticalSize: 1.w,),
            padding: EdgeInsets.all(5),
            color: Color.fromARGB(255, 187, 176, 176),
          ),
          Expanded(
          child: Container(
            margin: EdgeInsets.only(right: 5.w, bottom: 2.w, top: 2.w, left: 1.w),
            padding: EdgeInsets.only(left: 5.w, right: 2.w, top: 0.w, bottom: 0.w),
            decoration: BoxDecoration(
              border: Border.all(width: 1, color: Color.fromARGB(255, 64, 64, 64)),
                color: Color.fromARGB(255, 26, 26, 26),
              ...
              children: [
                TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Message',
                      hintStyle: TextStyle(fontSize: 5.w, color: Color.fromARGB(255, 244, 240, 240)),
                      constraints:
  ...
  //       children: [
  //         Expanded(
  //           child: widget.widgets.textField(textEditingController, 'Message'),
  //         ),
